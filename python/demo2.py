...
if __name__ == '__main__':
    #
    # filename = 'C:\\Users\\86183\\Desktop\\alldatademo\\allGennerdata.csv'
    # filename1 = 'C:\\Users\\86183\\Desktop\\alldatademo\\moneyMatrix.csv'
    # filename2 = 'C:\\Users\\86183\\Desktop\\alldatademo\\gennerKeyMapper.csv'
    # keymap = {}  # 标签映射表
    ...
    #     money_keymap = {}
    #     if float(as_num(float(i[0]))) > 0:
    #         listmony.append(float(as_num(float(i[0]))))
    #         listgenner.append(keymap[str(index)])
    #         # money_keymap['name'] = keymap[str(index)]
    #         # money_keymap['value'] = float(as_num(float(i[0])))
    #         # money_keymap_list.append(money_keymap)
    #     index += 1
    # money_keymap_list['number']=listmony
    # money_keymap_list['addr']=listgenner
    # print(money_keymap_list)

    filename2 = 'C:\\Users\\86183\\Desktop\\alldatademo\\resultalldata.csv'
    keymap1 = {}  # 标签映射表
    with open(filename2, 'r', encoding='utf8') as f:
        reader = csv.reader(f)
        for i in reader:
